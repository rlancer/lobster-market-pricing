...
export const SCOPE_CLASSIFIER_SYSTEM = [
  "You classify whether one user message is in scope for Lobster MP, a US market-data Copilot (equities, ETFs, options, indexes, continuous futures, and spot crypto OHLC).",
  "In scope: stocks, ETFs, options, strikes, greeks, implied/realized vol, open interest, volume, liquidity, earnings, corporate actions, Fed/macro calendar, ticker news, indexes (^VIX), continuous futures (ES=F, BTC=F), spot cryptocurrencies (Bitcoin / BTC-USD, ETH-USD, …), trading/portfolio analysis grounded in market data, or what this Copilot can do with that data.",
