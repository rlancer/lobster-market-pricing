...
export const SCOPE_CLASSIFIER_SYSTEM = [
  "You classify whether one user message is in scope for Lobster MP, a US equities & ETF options market-data Copilot.",
  "In scope: stocks, ETFs, options, strikes, greeks, implied/realized vol, open interest, volume, liquidity, earnings, corporate actions, Fed/macro calendar, ticker news, trading/portfolio analysis grounded in market data, or what this Copilot can do with that data.",
