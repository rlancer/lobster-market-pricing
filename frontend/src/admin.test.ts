...
test('isAdminNavPath covers the admin hub and tool routes', () => {
  ...
  assert.equal(isAdminNavPath('/admin/kalshi-parlay'), true);
  assert.equal(isAdminNavPath('/admin/marimo'), true);
  assert.equal(isAdminNavPath('/admin/marimo/lake-tape-backtest'), true);
...
test('isExperimentsNavPath covers experiments and legacy notebooks paths', () => {
  ...
  assert.equal(isExperimentsNavPath('/experiments/kalshi-parlays'), true);
  assert.equal(isExperimentsNavPath('/experiments/kalshi-parlay-books'), true);
  assert.equal(isExperimentsNavPath('/experiments/kalshi-parlay-payoffs'), true);
