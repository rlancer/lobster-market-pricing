...
const ENDPOINTS: { method: string; path: string; desc: ReactNode }[] = [
  ...
  { method: 'GET', path: '/api/experiments/kalshi-parlays', desc: 'Public live snapshot: Kalshi Fed combo mids vs independence of rate/dissent legs, homemade index/crypto parlays with lake return correlation, and sports parlays from options.kalshi_markets (MVE combos + selected legs, including last pre-settlement candles)' },
