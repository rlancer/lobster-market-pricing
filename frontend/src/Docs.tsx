...
const SURFACES = [
  ...
  },
  {
    route: '/data',
    title: 'Data',
    body: 'Catalog of everything that can feed an answer: Copilot tools, upstream APIs (CBOE, FRED, Fed, Tavily, Yahoo, Nasdaq, OpenFIGI), Iceberg lake tables, and a read-only SQL editor.',
  },
  {
    route: '/monitor',
    title: 'Monitor',
