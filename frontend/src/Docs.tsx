...
const JOBS = [
  ...
  ['kalshi-markets-hourly', 'Hourly', 'Curated Kalshi event contracts (Fed/CPI/indexes/crypto/oil) plus sports parlays (MVE combos + selected legs, ~30d candles) → options.kalshi_markets.'],
];
