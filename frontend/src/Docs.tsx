...
const JOBS = [
  ...
  ['etf-daily', 'Daily', 'Yahoo fund profile (expense ratio, AUM, yield) + top-10 holdings for the 92 optionable ETFs plus enrolled funds (RSP and other looked-up ETFs).'],
