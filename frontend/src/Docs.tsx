...
const SURFACES = [
  {
    route: '/',
    title: 'Chat',
    body: 'Natural-language questions grounded in the lake and live APIs (news, web search, FRED/Fed calendar). Optional Google sign-in saves the current chat so you can reopen it later; anonymous UUID chats still work. Deep-links into Data so you can inspect the SQL or browse the catalog.',
  },
  {
    route: '/data',
    title: 'Data',
