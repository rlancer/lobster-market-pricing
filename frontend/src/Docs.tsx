...
const ENDPOINTS: { method: string; path: string; desc: ReactNode }[] = [
  ...
  { method: 'GET', path: '/api/timeline/session', desc: 'Precomputed homepage Session card (index tape, next print, @nowlobster takeaway). D1 schema_cache, 5-minute cron warm, serve-stale' },
