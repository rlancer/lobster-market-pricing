/**
 * Suggested-trade types + leg formatting — shared by chat UI, portfolio,
 * bot trades, and admin trades (no React).
 */
...
export function resolveInstrument(leg: TradeLeg): LegInstrument {
...
export function biasLabel(bias: TradeBias): string {
